...
CREATE TABLE `user` (ID varchar(255) NOT NULL, profilePicture varchar(255), name varchar(255), email varchar(255) NOT NULL UNIQUE, hash varchar(255), salt varchar(255), privatePageId varchar(255), PRIMARY KEY (ID), UNIQUE INDEX (ID));
...
ALTER TABLE `user` ADD CONSTRAINT FKuser494196 FOREIGN KEY (profilePicture) REFERENCES media (ID) ON DELETE Cascade;
...
ALTER TABLE page ADD CONSTRAINT FKpage136719 FOREIGN KEY (banner) REFERENCES media (ID) ON DELETE Cascade;
