...
CREATE TABLE pageLid (userID varchar(36) NOT NULL, pageID varchar(36) NOT NULL, blocked tinyint NOT NULL, accepted tinyint NOT NULL, PRIMARY KEY (userID, pageID));
...
CREATE TABLE chatMessage (userID varchar(36) NOT NULL, chatID varchar(36) NOT NULL, message text NOT NULL, `date` timestamp(3) NOT NULL);
