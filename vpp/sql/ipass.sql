...
CREATE TABLE `session` (ID varchar(255) NOT NULL, validUntil timestamp NOT NULL, userID int(10) NOT NULL, PRIMARY KEY (ID));
ALTER TABLE page ADD CONSTRAINT FKpage818672 FOREIGN KEY (pageCreator) REFERENCES `user` (ID) ON DELETE Cascade;
