...
CREATE TABLE newPasswords (ID int(11) NOT NULL AUTO_INCREMENT, validUntil date NOT NULL, code text NOT NULL, userID int(10) NOT NULL, PRIMARY KEY (ID));
...
ALTER TABLE newPasswords ADD CONSTRAINT FKnewPasswor144172 FOREIGN KEY (userID) REFERENCES `user` (ID);
